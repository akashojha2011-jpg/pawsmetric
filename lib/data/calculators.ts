...
export const CALCULATORS: CalculatorData[] = [
  // 1. AGE & LIFE STAGE
  {
    ...
    author: { name: 'PawsMetric Team', role: 'Canine Health & Data Specialist' },
    reviewer: { name: 'PawsMetric Editorial Review', role: 'Canine Health Research' },
  ...
  },
  {
    ...
    lastUpdated: 'August 2026',
    author: { name: 'PawsMetric Editorial Team', role: 'Canine Health & Data Specialist' },
    reviewer: { name: 'PawsMetric Editorial Review', role: 'Canine Data Team' },
